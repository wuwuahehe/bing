...
#define AB_FOT_CHL_BLE_EN               1                       //FOTA升级BLE通道使能
 ...
 * Module    : 2.4G功能配置
 *****************************************************************************/
#define WIRELESS_ACCESS_CODE                    0x878ED7BE      //私有接入码定义，主从需保持一致
#define WIRELESS_CONN_EN                        1               //连接使能控制
#define WIRELESS_CONN_NB                        1               //最大连接个数设置,peripheral角色只支持1条连接
#define WIRELESS_PHY_FORCED                     2               //Connection PHY forced (0: passive 1: 1MBPS 2: 2MBPS)
#define WIRELESS_SCAN_EN                        0               //扫描使能控制
