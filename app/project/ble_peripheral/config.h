 ...
 * Module    : 提示音功能配置（PA2）
 *****************************************************************************/
#define TONE_PLAY_EN                    0          //提示音使能 （需把Output\bin文件夹下的测试音源放到Output\bin\res文件夹）
#define TONE_PLAY_SIN_DEC_EN            0          //正弦波解码使能
#define TONE_PLAY_MP3_DEC_EN            0          //MP3解码使能, 15K ram， 30K flash
#define TONE_PLAY_WAV_DEC_EN            0          //WAC解码使能，可通过 WAV_PACKED_FORMAT 切换WAV和ADPCM WAV
#define TONE_PLAY_THREAD_EN             0          //音频线程使能，避免其它处理阻塞提示音解码，消耗1K ram
#define TONE_PLAY_EXTERN_FLASH_EN       0          //外挂flash使能，需自行添加必要的外挂flash操作接口
