...
#define VUSB_2_VDDIO_EN                 1                       //是否使能VUSB到VDDIO的电源通路（系统只有VUSB供电的方案需要使能）
#define WK0_10S_RESET                   0                       //WK pin 10秒复位功能
#define SYS_SLEEP_EN                    0                       //系统休眠使能
#define SYS_SLEEP_TIME                  0						//自动休眠时间(秒), 0为不自动休眠
#define SYS_PWROFF_MODE                 PWROFF_NO_USED          //软关机模式选择，模式1 VDDIO掉电，模式2 VDDIO不掉电
...
#define USB_MIC_EN                      0
#define USB_CDC_EN                      0           //USB CDC虚拟串口使能
...
#define USB_VENDOR_DATA_IN_TEST         0                               //VENDOR测试(WK0三击减少音量)
