...
const uint8_t desc_itf_header_audio[] = {
    ...
    UA_SPEAKER_INPUT_ID,                    /* Terminal ID, The same of speaker stream TID */
    0x01,                                   /* Terminal Type: 0x0101 - USB Streaming LSB */
    0x01,                                   /* Terminal Type: 0x0101 - USB Streaming MSB */
    0x00,                                   /* Associate Terminal */
    0x01,                                   /* NrChannel, */
    0x04,                                   /* Channel Config LSB  (D0: Left Front, D1:Right Front) */
    0x00,                                   /* Channel Config MSB */
    0x00,                                   /* Channel Name */
    0x00,                                   /* Index of Channel String */

    0x09,                                   /* Num bytes of this descriptor */
    AUDIO_INTERFACE_DESCRIPTOR,             /* bDescriptorType, Audio Control Interface descriptor type */
    UA_FEATURE_UNIT_DESCRIPTOR,             /* bDescriptorSubtype, FEATURE_UNIT descriptor subtype */
    UA_SPEAKER_UNIT_ID,                     /* bUnitID, Feature Unit ID */
    UA_SPEAKER_INPUT_ID,                    /* bSourceID */
    0x01,                                   /* Control Size */
    0x01,                                   /* bmaControls(0): D0(Mute), D1(Volume),  mute and volume control supported for master channel */
    0x00,                                   /* bmaControls(1) */
    ...
    UA_SPEAKER_OUTPUT_ID,                   /* Terminal ID */
    0x01,                                   /* Terminal Type: 0x0301 = Speaker LSB */
    0x03,                                   /* Terminal Type: 0x0301 = Speaker MSB */
    0x00,                                   /* Associate Terminal */
    UA_SPEAKER_UNIT_ID,                     /* bSourceID */
    0x00,                                   /* Index of Channel String */
...
#if USB_SPEAKER_EN
AT(.rodata.usb.desc)
const uint8_t desc_itf_speaker_stream_audio[] = {
    0x09,                                   /* Num bytes of this descriptor */
    INTERFACE_DESCRIPTOR,                   /* Interface descriptor type */
    USB_AUDIO_STREAM_SPEAKER_ITF_INDEX,     /* Interface Number*/
    0x00,                                   /* Alternate interface number */
    0x00,                                   /* Num endpoints of this interface */
    0x01,                                   /* Interface Class: Audio */
    ...
    0x09,                                   /* Num bytes of this descriptor */
    INTERFACE_DESCRIPTOR,                   /* Interface descriptor type */
    USB_AUDIO_STREAM_SPEAKER_ITF_INDEX,     /* Interface Number (it will be rewrite by lib) */
    ...
    UA_SPEAKER_INPUT_ID,                    /* Terminal ID of Input Terminal, Audio USB Stream ID */
    ...
    BYTE0(AUDIO_SPEAKER_SAMPLE),            /* Sample Rate */
    BYTE1(AUDIO_SPEAKER_SAMPLE),
    BYTE2(AUDIO_SPEAKER_SAMPLE),

    //EndpointDescriptor:
    0x09,                                   /* Num bytes of this descriptor */
    ENDPOINT_DESCRIPTOR,                    /* Endpoint descriptor type */
    USB_AUDIO_EP_OUT_INDEX,                 /* Endpoint number */
    AUDIO_ISOOUT_TYPE,                      /* ISO endpoint, ADA */
    BYTE0(AUDIO_ISOOUT_SIZE),               /* Maximum packet size LSB */
    BYTE1(AUDIO_ISOOUT_SIZE),               /* Maximum packet size LSB */
    0x01,                                   /* ISO 1ms */
    0x00,                                   /* Refresh */
    0x00,                                   /* SynchAddress */
...
{
    *length = sizeof(desc_itf_speaker_stream_audio);
    return (u8 *)desc_itf_speaker_stream_audio;
}
#endif // USB_SPEAKER_EN
