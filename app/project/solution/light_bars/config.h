...
#define BSP_LEDC_EN                     1                       //灯带功能
#define BSP_IR_EN                       1                       //红外功能
#define BSP_MIC_EN                      1                       //MIC采样功能
 ...
 * Module    : BLE SCAN功能配置
 *****************************************************************************/
#define LE_SCAN_EN                      1           //BLE scan enable

/*****************************************************************************
 * Module    : 阈值跟踪闪烁算法配置
 *****************************************************************************/
#define THR_TRACK_FLASH_EN            0      //阈值跟踪闪烁算法
...
#define THR_TRACK_FLASH_DUMP_EN       0      //输出调试信息
