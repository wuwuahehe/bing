...
#if !LE_HID_EN
#undef LE_HID_CONSUMER
#undef LE_HID_DIGITIZER
#undef LE_HID_MOUSE
#undef LE_HID_KEYBOARD
#undef LE_CHECK_PEER_TYPE
#define LE_HID_CONSUMER             0
#define LE_HID_DIGITIZER            0
#define LE_HID_MOUSE                0
#define LE_HID_KEYBOARD             0
#define LE_CHECK_PEER_TYPE          0
#elif !(LE_HID_CONSUMER || LE_HID_DIGITIZER || LE_HID_MOUSE || LE_HID_KEYBOARD)
#error "Cannot enable the HID function without using any device type"
#endif // !LE_HID_EN
