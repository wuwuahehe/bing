...
#define lowpwr_deep_sleep_delay_reset() if(sys_cb.deep_sleep_delay != -1L) {sys_cb.deep_sleep_delay = sys_cb.deep_sleep_time;}

#define lowpwr_deep_sleep_auto_en()     if(sys_cb.deep_sleep_delay == -1L) {sys_cb.deep_sleep_delay = sys_cb.deep_sleep_time;}

#define lowpwr_deep_sleep_auto_dis()    sys_cb.deep_sleep_delay = -1L;
...
#define lowpwr_deep_sleep_delay_reset()

#define lowpwr_deep_sleep_auto_en()

#define lowpwr_deep_sleep_auto_dis()
