...
#define PARAM_HID_CLIENT_CONFIG     (PARAM_FOT_HASH + PARAM_FOT_HASH_LEN)                   //2BYTE
#define PARAM_HID_CLIENT_CONFIG_LEN 2
#define PARAM_CONN_ADDR             (PARAM_HID_CLIENT_CONFIG + PARAM_HID_CLIENT_CONFIG_LEN) //6BYTE
#define PARAM_CONN_ADDR_LEN         6
#endif
