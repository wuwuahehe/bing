...
static void adv_timer_gpio_init(void)
{
    ...
    gpio_func_mapping_config(GPIOA_REG, GPIO_PIN_0, GPIO_CROSSBAR_OUT_TOC1N);
    gpio_func_mapping_config(GPIOA_REG, GPIO_PIN_1, GPIO_CROSSBAR_OUT_TOC2N);
    gpio_func_mapping_config(GPIOA_REG, GPIO_PIN_2, GPIO_CROSSBAR_OUT_TOC3N);
}
static void adv_timer_init(void)
{
    ...
    adv_tim_ocinitstructure.tim_ocmode      = TIM_OCMODE_INACTIVE;
...
void adv_timer_ocinactive_example(void)
{
    tmrclk_diswdt();
    adv_timer_gpio_init();
    adv_timer_init();
