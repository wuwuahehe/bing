...
cd ..\..\
for %%a in ("%cd%") do (
echo 1 > %cd%\Output\obj\project\example\%%~nxa\ram.o
echo 1 > %cd%\Output\obj\project\example\%%~nxa\Output\bin\app.o
echo 1 > %cd%\Output\obj\project\example\%%~nxa\Output\bin\download.o
echo %cd%\Output\obj\project\example\%%~nxa
