...
******************************************************************************************************************************
**/
#ifndef _TOUCH_KEY_EXAMPLE_H
#define _TOUCH_KEY_EXAMPLE_H
...
//touch key参数
#define CDPR            100                 //Touch key charge and discharge period (0 ~ 1024), 每个通道可以独立配置。
...
#define TKPTHRESH       20                  //Touch key press threshold
#define TKRTHRESH       15                  //Touch key release threshold, TKRTHRESH = TKBCNT
#define SMALLTHD        3                   //update TKBCNT, TKCNT < (TKBCNT - SMALLTHD)
#define LARGETHD        (TKPTHRESH * 5)    //update TKBCNT, TKCNT > (TKBCNT + LARGETHD)
